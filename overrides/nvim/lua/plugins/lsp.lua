  ...
  config = function()
    vim.api.nvim_create_autocmd('LspAttach', {
      ...
      callback = function(event)
        ...
        -- Ruff: format on save (lint diagnostics already auto-displayed).
    ...
    local servers = {
      ...
      basedpyright = {
        -- Auto-detect project .venv so we don't need pyproject.toml config per project.
      ...
      ruff = {
        -- Disable ruff hover so basedpyright owns hover docs (avoid duplicate popups).
